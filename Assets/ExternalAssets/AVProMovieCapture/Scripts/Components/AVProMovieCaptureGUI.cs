...
public class AVProMovieCaptureGUI : MonoBehaviour 
{
	...
	private void CreateGUI()
	{
		...
		case AVProMovieCaptureBase.DownScale.Sixteenth:
			_downScaleIndex = 4;	
			break;
		case AVProMovieCaptureBase.DownScale.Custom:
			_downScaleIndex = 5;
			break;
		}
		
		_frameRates = new string[9];
		_frameRates[0] = "15";
		_frameRates[1] = "24";
		_frameRates[2] = "25";
		_frameRates[3] = "30";
		...
		case AVProMovieCaptureBase.FrameRate.Sixty:
			_frameRateIndex = 5;
			break;
		case AVProMovieCaptureBase.FrameRate.SeventyFive:
			_frameRateIndex = 6;
			break;
		case AVProMovieCaptureBase.FrameRate.Ninety:
			_frameRateIndex = 7;
			break;
		case AVProMovieCaptureBase.FrameRate.OneTwenty:
			_frameRateIndex = 8;
			break;
		}
	...
	void MyWindow(int id)
	{
		if (_movieCapture == null)
		{
			GUILayout.Label("AVProMovieCaptureGUI - No MovieCapture component set");
			return;
		}
		...
		{		
			...
			switch (_downScaleIndex)
			{
				...
				case 4:
					...
					break;
				case 5:
					_movieCapture._downScale = AVProMovieCaptureBase.DownScale.Custom;
					break;
			}
			GUILayout.EndHorizontal();
			
			GUILayout.BeginHorizontal(GUILayout.Width(256));
			if (_movieCapture._downScale == AVProMovieCaptureBase.DownScale.Custom)
			{
			...
			switch (_frameRateIndex)
			{
				...
				case 5:
					...
					break;
				case 6:
					_movieCapture._frameRate = AVProMovieCaptureBase.FrameRate.SeventyFive;
					break;
				case 7:
					_movieCapture._frameRate = AVProMovieCaptureBase.FrameRate.Ninety;
					break;
				case 8:
					_movieCapture._frameRate = AVProMovieCaptureBase.FrameRate.OneTwenty;
					break;
			}
			GUILayout.EndHorizontal();
